// Generated by SolidPython 1.1.3 on 2023-10-18 16:19:57
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


union() {
	translate(v = [0, 0, 0.1200000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [6.0000000000, 3.0000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.5001131233, 0]) {
															square(center = true, size = [0.9997737533, 0.9995475066]);
														}
														translate(v = [-2.5001131233, 0]) {
															square(center = true, size = [0.9997737533, 0.9995475066]);
														}
								...
								translate(v = [0, 0]) {
									union() {
										translate(v = [6.0000000000, 3.0000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.2501131233, 0]) {
														square(center = true, size = [1.4997737533, 1.9995475066]);
													}
													translate(v = [-2.2501131233, 0]) {
														square(center = true, size = [1.4997737533, 1.9995475066]);
													}
											...
											rotate(a = 0) {
												union() {
													translate(v = [2.5000000000, 0]) {
														square(center = true, size = [1.8000000000, 1.8000000000]);
													}
													translate(v = [-2.5000000000, 0]) {
														square(center = true, size = [1.8000000000, 1.8000000000]);
													}
	...
	union() {
		translate(v = [0.0000000000, 0.0000000000]) {
			linear_extrude(height = 2.1200000000) {
				union() {
					translate(v = [0, 0]) {
						union() {
							translate(v = [6.0000000000, 3.0000000000, 0]) {
