// Generated by SolidPython 1.1.3 on 2022-07-14 17:39:10


union() {
	translate(v = [63.0000000000, 31.5000000000, 0]) {
		union() {
	...
	translate(v = [27.0000000000, 31.5000000000, 0]) {
		union() {
			translate(v = [0.1054687500, 0.1054687500, 0]) {
				translate(v = [0, 0, 0]) {
					rotate(a = 180) {
	...
	translate(v = [63.0000000000, 13.5000000000, 0]) {
		union() {
			translate(v = [0.1054687500, 0.1054687500, 0]) {
				translate(v = [0, 0, 0]) {
					rotate(a = 180) {
	...
	translate(v = [27.0000000000, 13.5000000000, 0]) {
		union() {
			translate(v = [0.1054687500, 0.1054687500, 0]) {
				translate(v = [0, 0, 0]) {
					rotate(a = 180) {
...
def make_walls(diameter,thickness,grid_size,dims,height=20,segments=256):
    #dims = [casing_x, casing_y, casing_z]
    #wafer_wall_out = solid.circle(r=diameter/2, segments=segments)
    #wafer_wall_in = solid.circle(r=(diameter/2-thickness), segments=segments)
