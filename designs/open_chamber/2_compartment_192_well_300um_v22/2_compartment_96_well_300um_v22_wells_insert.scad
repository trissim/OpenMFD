// Generated by SolidPython 1.1.3 on 2024-10-09 22:52:16
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


scale(v = [1.0190000000, 1.0190000000, 1]) {
	union() {
		translate(v = [0, 0, 0.5000000000]) {
			union() {
												...
												rotate(a = 90) {
													union() {
														translate(v = [1.8037155460, 0]) {
															square(center = true, size = [0.8925689080, 1.1851378161]);
														}
														translate(v = [-1.8037155460, 0]) {
															square(center = true, size = [0.8925689080, 1.1851378161]);
														}
				...
				chamfer_extrude($fn = 20, angle = 10, height = 5.6000000000) {
					union() {
						translate(v = [0.0000000000, 0.0000000000]) {
							union() {
								translate(v = [0.0000000000, 0.0000000000]) {
									...
									rotate(a = 90) {
										union() {
											translate(v = [1.7500000000, 0]) {
												square(center = true, size = [1.3000000000, 1.3000000000]);
											}
											translate(v = [-1.7500000000, 0]) {
												square(center = true, size = [1.3000000000, 1.3000000000]);
											}
		...
		translate(v = [0, 0, 0.1000000000]) {
			linear_extrude(height = 0.4000000000) {
				difference() {
					...
					offset(chamfer = false, delta = -0.7000000000) {
						projection() {
							translate(v = [0, 0, 0.5000000000]) {
								union() {
									translate(v = [0, 0, 5.6000000000]) {
