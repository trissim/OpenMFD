// Generated by SolidPython 1.1.3 on 2024-12-10 10:24:44
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.8526539614, 0]) {
															square(center = true, size = [3.2946920772, 2.8893841543]);
														}
														translate(v = [-2.8526539614, 0]) {
															square(center = true, size = [3.2946920772, 2.8893841543]);
														}
