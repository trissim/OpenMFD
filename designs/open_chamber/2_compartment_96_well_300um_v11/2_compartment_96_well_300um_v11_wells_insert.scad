// Generated by SolidPython 1.1.3 on 2024-01-11 20:37:03
...
union() {
	translate(v = [0, 0, 0.1200000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
					chamfer_extrude($fn = 20, angle = 45, height = 1) {
						union() {
							translate(v = [0, 0]) {
								union() {
									translate(v = [9.0000000000, 4.5000000000, 0]) {
										rotate(a = 0) {
											union() {
												translate(v = [3.3251131233, 0]) {
													square(center = true, size = [2.3497737533, 0.9995475066]);
												}
												translate(v = [-3.3251131233, 0]) {
													square(center = true, size = [2.3497737533, 0.9995475066]);
												}
						...
						translate(v = [0, 0]) {
							union() {
								translate(v = [9.0000000000, 4.5000000000, 0]) {
									rotate(a = 0) {
										union() {
											translate(v = [2.8251131233, 0]) {
												square(center = true, size = [3.3497737533, 2.9995475066]);
											}
											translate(v = [-2.8251131233, 0]) {
												square(center = true, size = [3.3497737533, 2.9995475066]);
											}
						...
						translate(v = [0, 0]) {
							union() {
								translate(v = [9.0000000000, 4.5000000000, 0]) {
									rotate(a = 0) {
										union() {
											translate(v = [2.9400415076, 0]) {
												square(center = true, size = [3.1199169847, 3.5398339694]);
											}
											translate(v = [-2.9400415076, 0]) {
												square(center = true, size = [3.1199169847, 3.5398339694]);
											}
