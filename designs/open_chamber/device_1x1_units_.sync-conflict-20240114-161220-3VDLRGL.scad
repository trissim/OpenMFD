// Generated by SolidPython 1.1.3 on 2024-01-09 11:18:42
	...
	translate(v = [0, 0]) {
		union() {
					...
					union() {
						translate(v = [0, 0.0000000000]) {
							translate(v = [0, -0.0200000000]) {
								square(center = true, size = [4.5536754533, 0.0100000000]);
							}
						}
			...
			translate(v = [9.0000000000, 4.5000000000, 0]) {
				rotate(a = 0) {
					union() {
						translate(v = [3.3884188633, 0]) {
							square(center = true, size = [2.2231622734, 0.7463245467]);
						}
						translate(v = [-3.3884188633, 0]) {
							square(center = true, size = [2.2231622734, 0.7463245467]);
						}
