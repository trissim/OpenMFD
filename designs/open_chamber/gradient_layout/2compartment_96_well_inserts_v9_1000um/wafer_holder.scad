...
translate(v = [-0.0000000000, -0.0000000000]) {
	translate(v = [36.0000000000, 54.0000000000]) {
		difference() {
			difference() {
				cylinder($fn = 512, h = 0.6250000000, r1 = 78.1875000000, r2 = 78.1875000000);
				rotate(a = 90) {
					difference() {
						cylinder($fn = 512, h = 0.6250000000, r1 = 75.1875000000, r2 = 75.1875000000);
						translate(v = [-28.8218750000, 69.4439319000, 0]) {
							cube(center = false, size = [57.6437500000, 5.7435681000, 0.6250000000]);
						}
					}
				}
			}
			rotate(a = 90) {
				translate(v = [-5.0000000000, 69.4439319000, 0]) {
					cube(center = false, size = [10, 2, 0.6250000000]);
				}
			}
		}
	}
