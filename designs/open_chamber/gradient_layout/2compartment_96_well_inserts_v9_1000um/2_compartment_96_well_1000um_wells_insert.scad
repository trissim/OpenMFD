// Generated by SolidPython 1.1.3 on 2023-10-16 12:13:29
...
union() {
	translate(v = [0, 0, 0.0600000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
					chamfer_extrude($fn = 20, angle = 70, height = 0.5000000000) {
						union() {
							translate(v = [0, 0]) {
								union() {
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [3.6619824782, 0]) {
															square(center = true, size = [1.6760350436, 2.2920700872]);
														}
														translate(v = [-3.6619824782, 0]) {
															square(center = true, size = [1.6760350436, 2.2920700872]);
														}
								...
								translate(v = [0, 0]) {
									union() {
										translate(v = [9.0000000000, 4.5000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.9751131233, 0]) {
														square(center = true, size = [3.0497737533, 5.0395475066]);
													}
													translate(v = [-2.9751131233, 0]) {
														square(center = true, size = [3.0497737533, 5.0395475066]);
													}
