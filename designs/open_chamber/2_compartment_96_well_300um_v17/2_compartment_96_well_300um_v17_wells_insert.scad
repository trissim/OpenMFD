// Generated by SolidPython 1.1.3 on 2024-08-11 12:17:40
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.8601131233, 0]) {
															square(center = true, size = [3.2797737533, 2.8595475066]);
														}
														translate(v = [-2.8601131233, 0]) {
															square(center = true, size = [3.2797737533, 2.8595475066]);
														}
