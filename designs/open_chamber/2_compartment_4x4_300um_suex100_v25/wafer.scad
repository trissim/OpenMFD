...
projection() {
	rotate(a = 90) {
		difference() {
			cylinder($fn = 512, h = 0.5000000000, r1 = 50.0000000000, r2 = 50.0000000000);
			translate(v = [-16.2500000000, 47.2857007984, 0]) {
				cube(center = false, size = [32.5000000000, 2.7142992016, 0.5000000000]);
			}
		}
	}
}
