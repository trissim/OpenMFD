// Generated by SolidPython 1.1.3 on 2025-02-11 11:44:40
	...
	union() {
		translate(v = [0, 0, 0.7600000000]) {
			union() {
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [6.0000000000, 3.0000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.1874671558, 0]) {
															square(center = true, size = [1.6250656884, 1.5501313768]);
														}
														translate(v = [-2.1874671558, 0]) {
															square(center = true, size = [1.6250656884, 1.5501313768]);
														}
				...
				chamfer_extrude($fn = 20, angle = 16, height = 3.4000000000) {
					union() {
						translate(v = [0.0000000000, 0.0000000000]) {
							union() {
								translate(v = [0, 0]) {
				...
				translate(v = [0, 0, 0.0200000000]) {
					linear_extrude(height = 0.0400000000) {
						difference() {
							...
							offset(chamfer = false, delta = -0.5500000000) {
								projection() {
									translate(v = [0, 0, 0.7600000000]) {
										union() {
											translate(v = [0, 0, 3.4000000000]) {
