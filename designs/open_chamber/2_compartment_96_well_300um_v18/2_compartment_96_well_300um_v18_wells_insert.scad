...
scale(v = [1.0226000000, 1.0226000000, 1]) {
	union() {
		...
		union() {
			translate(v = [0, 0]) {
				linear_extrude(height = 2.3400000000) {
					union() {
						translate(v = [0, 0]) {
							union() {
								translate(v = [9.0000000000, 4.5000000000, 0]) {
		...
		translate(v = [0, 0, 0.1400000000]) {
			linear_extrude(height = 0.2000000000) {
				difference() {
					...
					offset(chamfer = false, delta = -0.8500000000) {
						projection() {
							translate(v = [0, 0, 0.3400000000]) {
								union() {
									translate(v = [0, 0, 4]) {
