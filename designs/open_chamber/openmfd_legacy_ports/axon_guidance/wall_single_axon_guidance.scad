...
union() {
	union() {
		translate(v = [-4.5000000000, 9.0000000000, 5.0000000000]) {
			cube(center = true, size = [7, 27, 10]);
		}
		translate(v = [9.0000000000, -4.5000000000, 5.0000000000]) {
			cube(center = true, size = [27, 7, 10]);
		}
		translate(v = [0, 27]) {
			translate(v = [9.0000000000, -4.5000000000, 5.0000000000]) {
				cube(center = true, size = [27, 7, 10]);
