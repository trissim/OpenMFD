...
union() {
	union() {
		translate(v = [-4.5000000000, 4.5000000000, 5.0000000000]) {
			cube(center = true, size = [7, 18, 10]);
		}
		translate(v = [13.5000000000, -4.5000000000, 5.0000000000]) {
			cube(center = true, size = [36, 7, 10]);
		}
		translate(v = [0, 18]) {
			translate(v = [13.5000000000, -4.5000000000, 5.0000000000]) {
				cube(center = true, size = [36, 7, 10]);
	...
	translate(v = [4.5000000000, 13.5000000000]) {
		difference() {
