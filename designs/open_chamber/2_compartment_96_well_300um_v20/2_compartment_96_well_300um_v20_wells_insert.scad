// Generated by SolidPython 1.1.3 on 2024-10-03 22:12:17
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.9287155460, 0]) {
															square(center = true, size = [3.1425689080, 2.5851378161]);
														}
														translate(v = [-2.9287155460, 0]) {
															square(center = true, size = [3.1425689080, 2.5851378161]);
														}
