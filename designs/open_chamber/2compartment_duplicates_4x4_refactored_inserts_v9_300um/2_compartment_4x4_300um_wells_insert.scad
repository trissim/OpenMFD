// Generated by SolidPython 1.1.3 on 2023-10-16 12:15:28
...
union() {
	translate(v = [0, 0, 0.0600000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
					chamfer_extrude($fn = 20, angle = 45, height = 0.5000000000) {
						union() {
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [6.0000000000, 3.0000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.3001131233, 0]) {
															square(center = true, size = [1.3997737533, 1.0995475066]);
														}
														translate(v = [-2.3001131233, 0]) {
															square(center = true, size = [1.3997737533, 1.0995475066]);
														}
				...
				chamfer_extrude($fn = 20, angle = 12, height = 4) {
					union() {
						translate(v = [0.0000000000, 0.0000000000]) {
							union() {
								translate(v = [0, 0]) {
									union() {
										translate(v = [6.0000000000, 3.0000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.0501131233, 0]) {
														square(center = true, size = [1.8997737533, 2.0995475066]);
													}
													translate(v = [-2.0501131233, 0]) {
														square(center = true, size = [1.8997737533, 2.0995475066]);
													}
	...
	union() {
		translate(v = [0.0000000000, 0.0000000000]) {
			linear_extrude(height = 2.0600000000) {
				union() {
					translate(v = [0, 0]) {
						union() {
							translate(v = [6.0000000000, 3.0000000000, 0]) {
