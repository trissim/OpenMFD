// Generated by SolidPython 1.1.3 on 2023-10-16 12:15:24
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [6.0000000000, 3.0000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [1.5750000000, 0]) {
															square(center = true, size = [2.8500000000, 4.0000000000]);
														}
														translate(v = [-1.5750000000, 0]) {
															square(center = true, size = [2.8500000000, 4.0000000000]);
														}
												...
												union() {
													translate(v = [0, 0.0000000000]) {
														translate(v = [0, -0.0200000000]) {
															square(center = true, size = [1.2000000000, 0.0100000000]);
														}
													}
...
def wells_top_bottom(center_gap,device_dims=None,shape=None,height=None, positions = None, dxf = False):
...
def make_device(design='open',rows=8,columns=6,wells_pos = 4.5,well_offset=3.2, well_rad=3.2,well_height=0.1,
    ...
    if design == "open":
        ...
        wells = wells_top_bottom(well_offset*2,device_dims=well_rad,height=well_height, dxf = dxf, positions = wells_pos)
    elif design == "closed":
        wells_pos=wells_pos_from_center_4(wells_pos)
        debug(wells,"wells")
        wells = four_corner(well_offset,well_heightdevice_dims=well_rad, dxf = dxf, positions = wells_pos)
    else:
