// Generated by SolidPython 1.1.3 on 2023-12-09 18:50:50
...
union() {
	translate(v = [0, 0, 0.1200000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
					chamfer_extrude($fn = 20, angle = 60, height = 1) {
						union() {
							translate(v = [0, 0]) {
								union() {
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [3.8661385271, 0]) {
															square(center = true, size = [1.2677229458, 1.4754458915]);
														}
														translate(v = [-3.8661385271, 0]) {
															square(center = true, size = [1.2677229458, 1.4754458915]);
														}
								...
								translate(v = [0, 0]) {
									union() {
										translate(v = [9.0000000000, 4.5000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [3.0001131233, 0]) {
														square(center = true, size = [2.9997737533, 4.9395475066]);
													}
													translate(v = [-3.0001131233, 0]) {
														square(center = true, size = [2.9997737533, 4.9395475066]);
													}
