// Generated by SolidPython 1.1.3 on 2025-02-05 19:06:32
			...
			translate(v = [0.0000000000, 0.0000000000]) {
				union() {
					translate(v = [4.5000000000, 2.2500000000, 0]) {
						rotate(a = 0) {
							union() {
								translate(v = [0.6375000000, 0]) {
									square(center = true, size = [0.9750000000, 4.0000000000]);
								}
								translate(v = [-0.6375000000, 0]) {
									square(center = true, size = [0.9750000000, 4.0000000000]);
								}
