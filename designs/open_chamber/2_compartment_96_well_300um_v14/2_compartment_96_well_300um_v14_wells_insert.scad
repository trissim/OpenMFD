// Generated by SolidPython 1.1.3 on 2024-05-08 19:40:10
		...
		difference() {
			union() {
				translate(v = [0, 0, 5.5000000000]) {
					chamfer_extrude($fn = 20, angle = 40, height = 0) {
						union() {
							translate(v = [0, 0]) {
								union() {
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [2.9845305446, 0]) {
															square(center = true, size = [3.0309389108, 2.3618778216]);
														}
														translate(v = [-2.9845305446, 0]) {
															square(center = true, size = [3.0309389108, 2.3618778216]);
														}
				...
				chamfer_extrude($fn = 20, angle = 12, height = 5.5000000000) {
					union() {
						translate(v = [0, 0]) {
							union() {
								translate(v = [0, 0]) {
