// Generated by SolidPython 1.1.3 on 2024-03-10 01:14:06
...
difference() {
		...
		union() {
			translate(v = [0, -38.5875, 0]) {
				translate(v = [0, 0, 17.0000000000]) {
					cube(center = true, size = [100, 2.6750000000, 0]);
				}
			}
			translate(v = [0, 38.5875, 0]) {
				translate(v = [0, 0, 17.0000000000]) {
			...
			translate(v = [-58.125, 0, 0]) {
				translate(v = [0, 0, 17.0000000000]) {
					cube(center = true, size = [4.2500000000, 67, 0]);
				}
			}
			translate(v = [58.125, 0, 0]) {
				translate(v = [0, 0, 17.0000000000]) {
	...
	union() {
		translate(v = [0, 0, 17.0000000000]) {
			cube(center = true, size = [116.25, 67, 0]);
		}
		translate(v = [0, 0, 17.0000000000]) {
			cube(center = true, size = [100, 77.175, 0]);
		}
	}
}
/***********************************************
