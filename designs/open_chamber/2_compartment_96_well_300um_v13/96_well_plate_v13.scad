// Generated by SolidPython 1.1.3 on 2024-02-26 13:26:16
		...
		union() {
			translate(v = [0, -38.5875, 0]) {
				translate(v = [0, 0, 13.0000000000]) {
					cube(center = true, size = [100, 2.6750000000, 8]);
				}
			}
			translate(v = [0, 38.5875, 0]) {
				translate(v = [0, 0, 13.0000000000]) {
			...
			translate(v = [-58.125, 0, 0]) {
				translate(v = [0, 0, 13.0000000000]) {
					cube(center = true, size = [4.2500000000, 67, 8]);
				}
			}
			translate(v = [58.125, 0, 0]) {
				translate(v = [0, 0, 13.0000000000]) {
...
base_name="96_well_plate_"+version
#basic plate dims
...
#device_dims = np.array(device_dims)+device_dims_tol
