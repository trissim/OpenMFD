// Generated by SolidPython 1.1.3 on 2024-01-15 23:59:07
...
union() {
	translate(v = [0, 0, 0.2000000000]) {
		difference() {
			union() {
				translate(v = [0, 0, 4]) {
					chamfer_extrude($fn = 20, angle = 40, height = 1) {
						union() {
							translate(v = [0, 0]) {
								union() {
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [3.2446629389, 0]) {
															square(center = true, size = [2.5106741221, 1.3213482443]);
														}
														translate(v = [-3.2446629389, 0]) {
															square(center = true, size = [2.5106741221, 1.3213482443]);
														}
								...
								translate(v = [0, 0]) {
									union() {
										translate(v = [9.0000000000, 4.5000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.9200415076, 0]) {
														square(center = true, size = [3.1599169847, 3.6198339694]);
													}
													translate(v = [-2.9200415076, 0]) {
														square(center = true, size = [3.1599169847, 3.6198339694]);
													}
