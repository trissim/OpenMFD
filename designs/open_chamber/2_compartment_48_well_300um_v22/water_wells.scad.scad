// Generated by SolidPython 1.1.3 on 2024-10-09 19:01:16
...
union() {
	union() {
		translate(v = [43.5, 0]) {
			difference() {
				difference() {
					square(center = true, size = [10, 59.0]);
					union() {
						translate(v = [-5.0, 29.5]) {
							translate(v = [0, -10]) {
				...
				square(center = true, size = [10, 5.0]);
			}
		}
		mirror(v = [1, 0, 0]) {
			translate(v = [43.5, 0]) {
	...
	union() {
		translate(v = [0, -34.5]) {
			difference() {
				difference() {
					square(center = true, size = [95, 10]);
					union() {
						translate(v = [-47.5, 5.0]) {
							translate(v = [0, -10]) {
								polygon(points = [[0, 0], [0, 10], [0, 10], [0, 10], [10, 10], [10, 10]]);
							}
						}
				...
				square(center = true, size = [5.0, 10]);
			}
		}
		mirror(v = [0, 1, 0]) {
			translate(v = [0, -34.5]) {
