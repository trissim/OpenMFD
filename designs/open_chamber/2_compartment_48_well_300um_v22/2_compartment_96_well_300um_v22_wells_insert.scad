// Generated by SolidPython 1.1.3 on 2024-10-09 22:52:47
												...
												rotate(a = 90) {
													union() {
														translate(v = [2.9287155460, 0]) {
															square(center = true, size = [3.1425689080, 3.5851378161]);
														}
														translate(v = [-2.9287155460, 0]) {
															square(center = true, size = [3.1425689080, 3.5851378161]);
														}
									...
									rotate(a = 90) {
										union() {
											translate(v = [4.0000000000, 0]) {
												square(center = true, size = [2.1000000000, 2.1000000000]);
											}
											translate(v = [-4.0000000000, 0]) {
												square(center = true, size = [2.1000000000, 2.1000000000]);
											}
