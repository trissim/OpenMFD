// Generated by SolidPython 1.1.3 on 2024-06-19 00:59:38
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


union() {
	translate(v = [0, 0, 0.2400000000]) {
		union() {
								...
								translate(v = [0, 0]) {
									union() {
										translate(v = [9.0000000000, 4.5000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [3.0195305446, 0]) {
														square(center = true, size = [2.9609389108, 2.2218778216]);
													}
													translate(v = [-3.0195305446, 0]) {
														square(center = true, size = [2.9609389108, 2.2218778216]);
													}
	...
	union() {
		translate(v = [0, 0]) {
			linear_extrude(height = 2.2400000000) {
				union() {
					translate(v = [0, 0]) {
						union() {
							translate(v = [9.0000000000, 4.5000000000, 0]) {
