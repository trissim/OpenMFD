	...
	scale(v = [0.8000000000, 0.8000000000]) {
		union() {
			...
			translate(v = [54.0000000000, -13.5000000000]) {
				union() {
					text(halign = "center", size = 2, text = "Cure at 100°C (scale: 0.8000)", valign = "center");
					translate(v = [0, -4.5000000000]) {
						text(halign = "center", size = 2, text = "Use 60mL of Sylgard 184 in 1:10 ratio", valign = "center");
					}
				}
			}
		}
