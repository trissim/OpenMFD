...
projection() {
	rotate(a = 90) {
		difference() {
			cylinder($fn = 512, h = 0.6250000000, r1 = 75.0000000000, r2 = 75.0000000000);
			translate(v = [-28.7500000000, 69.2707550125, 0]) {
				cube(center = false, size = [57.5000000000, 5.7292449875, 0.6250000000]);
			}
		}
	}
}
