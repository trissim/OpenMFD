// Generated by SolidPython 1.1.3 on 2025-03-11 10:18:23


difference() {
	union() {
		difference() {
			translate(v = [-2.75,-2.75]) {
				translate(v = [35.,35.]) {
					projection() {
						rotate(a = 90) {
							difference() {
	...
	scale(v = [1, 1]) {
		union() {
			...
			union() {
				...
				translate(v = [0, -61.2500000000]) {
					translate(v = [35.0000000000, 35.0000000000]) {
						translate(v = [2.7500000000, 2.7500000000]) {
							union() {
								text(halign = "center", size = 2, text = "Cure @ room temperature, no shrinkage compensation", valign = "center");
								translate(v = [0, -8.7500000000]) {
