// Generated by SolidPython 1.1.3 on 2022-10-17 15:38:31
...
union() {
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [35.0000000000, 35.0000000000]) {
			difference() {
				difference() {
					cylinder($fn = 512, h = 0.5000000000, r1 = 53.5000000000, r2 = 53.5000000000);
					rotate(a = 90) {
						difference() {
							cylinder($fn = 512, h = 0.5000000000, r1 = 50.5000000000, r2 = 50.5000000000);
							translate(v = [-16.4125000000, 47.7585578064, 0]) {
								cube(center = false, size = [32.8250000000, 2.7414421936, 0.5000000000]);
							}
						}
					}
				}
				rotate(a = 90) {
					translate(v = [-10.0000000000, 47.7585578064, 0]) {
						cube(center = false, size = [20, 1.5000000000, 0.5000000000]);
					}
				}
			}
		}
