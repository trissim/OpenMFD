// Generated by SolidPython 1.1.3 on 2022-11-15 14:23:04
...
union() {
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [35.0000000000, 35.0000000000]) {
			difference() {
				difference() {
					cylinder($fn = 512, h = 0.5000000000, r1 = 53.1250000000, r2 = 53.1250000000);
					rotate(a = 90) {
						difference() {
							cylinder($fn = 512, h = 0.5000000000, r1 = 50.1250000000, r2 = 50.1250000000);
							translate(v = [-16.2906250000, 47.4039150504, 0]) {
								cube(center = false, size = [32.5812500000, 2.7210849496, 0.5000000000]);
							}
						}
					}
				}
				rotate(a = 90) {
					translate(v = [-5.0000000000, 47.4039150504, 0]) {
						cube(center = false, size = [10, 2, 0.5000000000]);
					}
				}
			}
		}
