// Generated by SolidPython 1.1.3 on 2022-11-23 19:51:19
	...
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [35.0000000000, 35.0000000000]) {
			translate(v = [0, 0, 2.5000000000]) {
				difference() {
					cube(center = true, size = [100, 130.0000000000, 5]);
					union() {
						translate(v = [38.3000000000, 53.3000000000]) {
							cylinder(center = true, h = 5, r = 3.9000000000);
						}
						translate(v = [-38.3000000000, 53.3000000000]) {
							cylinder(center = true, h = 5, r = 3.9000000000);
						}
