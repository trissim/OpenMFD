// Generated by SolidPython 1.1.3 on 2023-01-24 10:58:01
...
union() {
	translate(v = [0, 0, 0.1000000000]) {
		difference() {
			chamfer_extrude($fn = 20, angle = 10, height = 4) {
				union() {
					translate(v = [0, 0, 0.5000000000]) {
						chamfer_extrude($fn = 20, angle = 25, height = 4) {
							union() {
										...
										translate(v = [0, 0]) {
											union() {
												translate(v = [6.0000000000, 3.0000000000, 0]) {
													rotate(a = 0) {
														union() {
															translate(v = [2.6826153163, 0]) {
																square(center = true, size = [0.6347693674, 0.2695387348]);
															}
															translate(v = [-2.6826153163, 0]) {
																square(center = true, size = [0.6347693674, 0.2695387348]);
															}
			...
			translate(v = [0, 0, -0.0010000000]) {
				chamfer_extrude($fn = 20, angle = 10, height = 3.0000000000) {
					union() {
						translate(v = [0, 0]) {
							union() {
								translate(v = [6.0000000000, 3.0000000000, 0]) {
									rotate(a = 0) {
										union() {
											translate(v = [2.2789809421, 0]) {
												square(center = true, size = [1.4420381157, 1.8840762315]);
											}
											translate(v = [-2.2789809421, 0]) {
												square(center = true, size = [1.4420381157, 1.8840762315]);
											}
	...
	linear_extrude(height = 4.1000000000) {
		union() {
			translate(v = [0, 0]) {
				union() {
					translate(v = [6.0000000000, 3.0000000000, 0]) {
