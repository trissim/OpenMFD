// Generated by SolidPython 1.1.3 on 2023-07-07 07:12:53
...
union() {
	translate(v = [0, 0, 0.0400000000]) {
		difference() {
							...
							translate(v = [0, 0]) {
								union() {
									translate(v = [6.0000000000, 3.0000000000, 0]) {
										rotate(a = 0) {
											union() {
												translate(v = [2.2601357480, 0]) {
													square(center = true, size = [1.4797285040, 1.9594570080]);
												}
												translate(v = [-2.2601357480, 0]) {
													square(center = true, size = [1.4797285040, 1.9594570080]);
												}
			...
			translate(v = [0, 0, -0.0010000000]) {
				chamfer_extrude($fn = 20, angle = 12, height = 3.0000000000) {
					union() {
						translate(v = [0.0000000000, 0.0000000000]) {
							union() {
								translate(v = [0, 0]) {
									union() {
										translate(v = [6.0000000000, 3.0000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.4301809973, 0]) {
														square(center = true, size = [1.1396380053, 1.2792760106]);
													}
													translate(v = [-2.4301809973, 0]) {
														square(center = true, size = [1.1396380053, 1.2792760106]);
													}
	...
	union() {
		translate(v = [0.0000000000, 0.0000000000]) {
			linear_extrude(height = 3.0800000000) {
				union() {
					translate(v = [0, 0]) {
						union() {
							translate(v = [6.0000000000, 3.0000000000, 0]) {
