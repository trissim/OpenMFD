// Generated by SolidPython 1.0.4 on 2021-11-02 16:05:24


translate(v = [4.5000000000, 2.2500000000]) {
	union() {
...
(open_chamber_wells,_),(open_chamber_channels,_),_ = make_open_chamber(wells_pos=wells_pos_from_center_2(2),well_rad=1.5, chan_l=1, chan_w=0.01, chan_gap=0.02, num_chans=60,
                                         rows=6,columns=8,casing_x=9,casing_y=4.5,chamber_len_until=1, rotate_units=0,alignment=None)
file_path="./designs/open_chamber/device_96_well_3mm_diameter_"
solid.scad_render_to_file(open_chamber_wells,file_path+"wells.scad")
to_dxf(file_path+"wells.scad")
solid.scad_render_to_file(open_chamber_channels,file_path+"channels.scad")
to_dxf(file_path+"channels.scad")
...
_,_,(open_chamber,_)= make_open_chamber(wells_pos=wells_pos_from_center_2(2),
                                        well_rad=1.5,chan_l=1,chan_w=0.01,chan_gap=0.02,num_chans=75,
