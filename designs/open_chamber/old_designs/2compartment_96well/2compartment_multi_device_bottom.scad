// Generated by SolidPython 1.1.3 on 2022-07-21 18:18:32
...
def add_wafer_to_mask(wafer_size,mask,grid_size,dims):
    width = grid_size[0]*dims[0]
    length = grid_size[1]*dims[1]
    wafer_mask = solid.circle(r=wafer_size/2,segments=512)
    #wafer_mask = solid.translate([grid_size[1]*dims[1]/2.0,grid_size[0]*dims[0]/2.0])(wafer_circle)
    wafer_mask = solid.translate([width/2,length/2])(wafer_mask)
