// Generated by SolidPython 1.1.3 on 2023-07-03 18:05:35
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


union() {
	translate(v = [0, 0, 0.0800000000]) {
		difference() {
			chamfer_extrude($fn = 20, angle = 15, height = 4) {
				union() {
							...
							translate(v = [0, 0]) {
								union() {
									translate(v = [6.0000000000, 3.0000000000, 0]) {
										rotate(a = 0) {
											union() {
												translate(v = [2.3662831426, 0]) {
													square(center = true, size = [1.2674337148, 1.5348674296]);
												}
												translate(v = [-2.3662831426, 0]) {
													square(center = true, size = [1.2674337148, 1.5348674296]);
												}
			...
			translate(v = [0, 0, -0.0010000000]) {
				chamfer_extrude($fn = 20, angle = 15, height = 3.0000000000) {
					union() {
						translate(v = [0.0000000000, 0.0000000000]) {
							union() {
								translate(v = [0, 0]) {
									union() {
										translate(v = [6.0000000000, 3.0000000000, 0]) {
											rotate(a = 0) {
												union() {
													translate(v = [2.5002577388, 0]) {
														square(center = true, size = [0.9994845224, 0.9989690448]);
													}
													translate(v = [-2.5002577388, 0]) {
														square(center = true, size = [0.9994845224, 0.9989690448]);
													}
	...
	union() {
		translate(v = [0.0000000000, 0.0000000000]) {
			linear_extrude(height = 3.1200000000) {
				union() {
					translate(v = [0, 0]) {
						union() {
							translate(v = [6.0000000000, 3.0000000000, 0]) {
								rotate(a = 0) {
									union() {
										translate(v = [2.5000000000, 0]) {
											square(center = true, size = [1.7000000000, 1.7000000000]);
										}
										translate(v = [-2.5000000000, 0]) {
											square(center = true, size = [1.7000000000, 1.7000000000]);
										}
