...
union() {
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [35.0000000000, 35.0000000000]) {
			difference() {
				cube(center = true, size = [100, 100, 5]);
				union() {
					translate(v = [41.5000000000, 41.5000000000]) {
						cylinder(center = true, h = 5, r = 4.2500000000);
					}
					translate(v = [-41.5000000000, 41.5000000000]) {
						cylinder(center = true, h = 5, r = 4.2500000000);
					}
	...
	chamfer_extrude($fn = 20, angle = 1, height = 50) {
		union() {
					...
					translate(v = [0, 0]) {
						union() {
							translate(v = [6.0000000000, 3.0000000000, 0]) {
								rotate(a = 0) {
									union() {
										translate(v = [2.8134188633, 0]) {
											square(center = true, size = [0.3731622734, 0.2536754533]);
										}
										translate(v = [-2.8134188633, 0]) {
											square(center = true, size = [0.3731622734, 0.2536754533]);
										}
