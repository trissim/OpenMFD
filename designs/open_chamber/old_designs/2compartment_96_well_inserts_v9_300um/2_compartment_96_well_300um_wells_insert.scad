// Generated by SolidPython 1.1.3 on 2023-10-16 11:53:18
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [3.0501131233, 0]) {
															square(center = true, size = [2.8997737533, 4.0395475066]);
														}
														translate(v = [-3.0501131233, 0]) {
															square(center = true, size = [2.8997737533, 4.0395475066]);
														}
