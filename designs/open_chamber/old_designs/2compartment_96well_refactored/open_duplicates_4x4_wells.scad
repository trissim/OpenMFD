...
union() {
						...
						translate(v = [0, 0]) {
							union() {
								translate(v = [9.0000000000, 4.5000000000, 0]) {
									rotate(a = 0) {
										union() {
											translate(v = [2.7406538291, 0]) {
												square(center = true, size = [3.5186923418, 6.0073846837]);
											}
											translate(v = [-2.7406538291, 0]) {
												square(center = true, size = [3.5186923418, 6.0073846837]);
											}
	...
	linear_extrude(height = 0.6250000000) {
		projection() {
			chamfer_extrude($fn = 20, angle = 25, height = 1) {
				union() {
					translate(v = [0, 0]) {
