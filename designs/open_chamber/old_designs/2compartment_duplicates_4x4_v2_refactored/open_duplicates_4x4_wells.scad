// Generated by SolidPython 1.1.3 on 2023-01-09 23:21:46
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


union() {
	translate(v = [0, 0, 0.5000000000]) {
		chamfer_extrude($fn = 20, angle = 25, height = 1) {
			union() {
						...
						translate(v = [0, 0]) {
							union() {
								translate(v = [6.0000000000, 3.0000000000, 0]) {
									rotate(a = 0) {
										union() {
											translate(v = [1.9831538291, 0]) {
												square(center = true, size = [2.0336923418, 3.0673846837]);
											}
											translate(v = [-1.9831538291, 0]) {
												square(center = true, size = [2.0336923418, 3.0673846837]);
											}
