// Generated by SolidPython 1.1.3 on 2022-11-29 17:14:39
use </home/ts/code/projects/mfd/chamfer_extrude.scad>


chamfer_extrude($fn = 100, angle = 10, height = 2) {
	union() {
		translate(v = [0, 0]) {
			union() {
				translate(v = [6.0000000000, 3.0000000000, 0]) {
					rotate(a = 0) {
						union() {
							translate(v = [1.9263269807, 0]) {
								square(center = true, size = [2.1473460386, 3.2946920772]);
							}
							translate(v = [-1.9263269807, 0]) {
								square(center = true, size = [2.1473460386, 3.2946920772]);
							}
