// Generated by SolidPython 1.1.3 on 2022-11-24 15:47:28


difference() {
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [8.7500000000, 8.7500000000]) {
			translate(v = [0, 0, 2.5000000000]) {
				difference() {
					cube(center = true, size = [50, 50, 5]);
					union() {
						translate(v = [13.0000000000, 13.0000000000]) {
							cylinder(center = true, h = 5, r = 4.0000000000);
						}
						translate(v = [-13.0000000000, 13.0000000000]) {
							cylinder(center = true, h = 5, r = 4.0000000000);
						}
