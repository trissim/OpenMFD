// Generated by SolidPython 1.1.3 on 2022-11-29 13:56:05


linear_extrude(height = 2, scale = 0.8000000000) {
	union() {
...
def make_posts(post_shape,post_height,taper=1):
    posts = solid.linear_extrude(height=post_height,scale=taper)(post_shape)
    return posts
