// Generated by SolidPython 1.1.3 on 2024-01-09 10:38:46
...
union() {
	translate(v = [0.0000000000, 0.0000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
			translate(v = [0, 0, -1.5000000000]) {
				cylinder($fn = 64, center = true, h = 3, r = 8.4000000000);
			}
		}
	}
	translate(v = [0.0000000000, 22.8000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 45.6000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 68.4000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 91.2000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 114.0000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [22.8000000000, 22.8000000000, 6]);
			}
