// Generated by SolidPython 1.1.3 on 2024-01-19 11:14:05
	...
	union() {
		difference() {
			difference() {
										...
										projection() {
											intersection() {
												difference() {
													...
													translate(v = [0, 0, 1.2500000000]) {
														cube(center = true, size = [122.5000000000, 81.3500000000, 2.5000000000]);
													}
												}
												union() {
				...
				union() {
					translate(v = [-61.2500000000, 40.6750000000, 8.5000000000]) {
					...
					translate(v = [0, 0, 0.0000000000]) {
						difference() {
							rotate(a = 90) {
								difference() {
									translate(v = [0, 0, 8.2500000000]) {
										cube(center = true, size = [24, 3, 11.5000000000]);
									}
									translate(v = [12.0000000000, 0, 8.2500000000]) {
										cube(center = true, size = [12.0000000000, 3, 11.5000000000]);
									}
								}
							}
							translate(v = [0, 0, 8.2500000000]) {
