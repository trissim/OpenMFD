...
union() {
	translate(v = [0.0000000000, 0.0000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
			translate(v = [0, 0, -1.5000000000]) {
				cylinder($fn = 64, center = true, h = 3, r = 7.9000000000);
			}
		}
	}
	translate(v = [0.0000000000, 21.8000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 43.6000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 65.4000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 87.2000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 109.0000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [21.8000000000, 21.8000000000, 6]);
			}
