// Generated by SolidPython 1.1.3 on 2024-01-11 19:14:19
		...
		difference() {
			difference() {
				...
				translate(v = [0, 0, 1.5000000000]) {
					cube(center = true, size = [125.5000000000, 83.3500000000, 3]);
				}
			}
			union() {
					...
					union() {
						difference() {
							translate(v = [0, 0, 10.0000000000]) {
								difference() {
									cylinder($fn = 64, center = true, h = 14.0000000000, r = 9.0000000000);
									cylinder($fn = 64, center = true, h = 14.0000000000, r = 7.9000000000);
								}
							}
							union() {
								rotate(a = 0.0000000000) {
									translate(v = [0, 0, 17.0000000000]) {
										translate(v = [0, 0, -2.0000000000]) {
											cube(center = true, size = [18, 1.3788101091, 4]);
										}
									}
								}
						...
						translate(v = [0, 0, 4.0000000000]) {
							difference() {
								...
								cylinder($fn = 64, center = true, h = 2, r = 7.9000000000);
							}
						}
					}
				}
