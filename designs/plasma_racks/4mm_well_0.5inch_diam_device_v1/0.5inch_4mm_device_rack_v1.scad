...
union() {
	translate(v = [0.0000000000, 0.0000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
			translate(v = [0, 0, -1.5000000000]) {
				cylinder($fn = 64, center = true, h = 3, r = 7.3500000000);
			}
		}
	}
	translate(v = [0.0000000000, 20.7000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 41.4000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 62.1000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 82.8000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
	...
	translate(v = [0.0000000000, 103.5000000000, 0.0000000000]) {
		difference() {
			translate(v = [0, 0, -3.0000000000]) {
				cube(center = true, size = [20.7000000000, 20.7000000000, 6]);
			}
