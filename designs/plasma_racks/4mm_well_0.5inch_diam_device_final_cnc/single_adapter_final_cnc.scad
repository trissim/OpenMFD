// Generated by SolidPython 1.1.3 on 2024-03-05 17:38:12


union() {
	translate(v = [0, 0, 0.5000000000]) {
		difference() {
			cylinder($fn = 64, center = true, h = 1, r = 11.0000000000);
			cylinder($fn = 64, center = true, h = 1, r = 7.7500000000);
		}
	}
	difference() {
		translate(v = [0, 0, 3.5000000000]) {
			cylinder($fn = 64, center = true, h = 5, r = 11.0000000000);
		}
		translate(v = [0, 0, 3.5000000000]) {
			cylinder($fn = 64, center = true, h = 5, r = 10.2500000000);
		}
	}
	difference() {
		translate(v = [0, 0, 3.0000000000]) {
			cylinder($fn = 64, center = true, h = 4, r = 8.5000000000);
		}
		translate(v = [0, 0, 3.0000000000]) {
			cylinder($fn = 64, center = true, h = 4, r = 7.7500000000);
		}
	}
}
/***********************************************
...
base_name="single_adapter_"+version
adapter_diam=22
