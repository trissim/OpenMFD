// Generated by SolidPython 1.1.3 on 2024-01-14 17:05:25
...
union() {
	difference() {
		difference() {
			union() {
				difference() {
					union() {
						...
						translate(v = [0, 0, 12.7500000000]) {
							cube(center = true, size = [123.5000000000, 82.3500000000, 8.5000000000]);
						}
					}
				...
				intersection() {
					difference() {
						...
						translate(v = [0, 0, 1.5000000000]) {
							cube(center = true, size = [123.5000000000, 82.3500000000, 3]);
						}
					}
					union() {
						translate(v = [-63.7500000000, 42.6750000000, 0]) {
							translate(v = [0, 0, 1.5000000000]) {
								cube(center = true, size = [97.5000000000, 75.3500000000, 3]);
							}
						}
						translate(v = [63.7500000000, 42.6750000000, 0]) {
							translate(v = [0, 0, 1.5000000000]) {
			...
			union() {
				translate(v = [-61.7500000000, 41.1750000000, 8.5000000000]) {
					...
					union() {
						difference() {
							translate(v = [0, 0, 10.0000000000]) {
								difference() {
									...
									cylinder($fn = 64, center = true, h = 14.0000000000, r = 7.6500000000);
								}
							}
							union() {
								rotate(a = 0.0000000000) {
									translate(v = [0, 0, 17.0000000000]) {
										translate(v = [0, 0, -1.5000000000]) {
											cube(center = true, size = [18, 4.0055306333, 3]);
										}
									}
								}
						...
						translate(v = [0, 0, 4.0000000000]) {
							difference() {
								...
								cylinder($fn = 64, center = true, h = 2, r = 7.6500000000);
							}
						}
					}
				}
