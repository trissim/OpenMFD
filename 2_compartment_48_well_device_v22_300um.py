...
import pudb
version=22
base_path="./designs/open_chamber/2_compartment_48_well_300um_v"+str(version)+"/"
...
#add water_wells
water_wells = make_water_wells(glass_size,glass_error,dims,grid_size)
