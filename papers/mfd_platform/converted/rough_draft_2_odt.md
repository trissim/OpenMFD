...
- **B. State of the Art**
  ...
  - *Casting SU-8 using the glass photomask as the wafer and using a PDMS mold aligned on the glass substrate to contained the ultra thick casted SU-8 ( Takahiro Tamura, 2018*)
  ...
  - directly 3d printing tall PDMS walls to create large empty wells using a bioprinter (Janko Kajtez 2020)
