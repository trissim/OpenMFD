...
import numpy as np
base_path="./designs/open_chamber/2_compartment_96_well_300um_v11/"
device_name="2_compartment_96_well_300um_v11"
design = "open"
wells_pos=4.5
well_rad=5/2.0
...
def make_well_insert_all(degrees_in,degrees_out,height_in,height_out,inner_well_rad):
    ...
    open_duplicates_4x4_empty_top, _, _  = make_well_insert(make_chamber_insert_holes,degrees_in,height_in,False,
...
open_duplicates_4x4_wells = make_well_insert_all(degrees_in, degrees_out,insert_height_in, insert_height,pin_dims)
...
#well_shape=solid.cylinder(r1=pin_dims[0]/2,r2=pin_dims[0],h=0.060, segments=4, center = True)
#well_shape = solid.rotate(45)(well_shape)
##well_shape=solid.translate([0,0,-pin_height])(well_shape)
#(chamber_insert_holes_pyramid,_), _ , _ =make_chamber_insert_holes(well_rad=pin_dims,chan_l=chan_l,chamber_width=chamber_width,add_chambers=False,well_shape=well_shape)
#chamber_insert_holes_pyramid_multi = make_unit_array(chamber_insert_holes_pyramid,dims,grid_size, dxf=True, alignment = None,units_from_center=units_from_center,alignment_offset=alignment_offset,alignment_mark_size=alignment_mark_size)
