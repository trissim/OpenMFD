...
import numpy as np
base_path="./designs/open_chamber/2_compartment_96_well_300um_v12/"
device_name="2_compartment_96_well_300um_v12"
design = "open"
wells_pos=4.5
well_rad=5/2.0
...
open_duplicates_4x4_wells = make_well_insert_all(degrees_in, degrees_out,insert_height_in, insert_height,pin_dims,add_chambers=False)
