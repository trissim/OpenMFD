...
base_path="./designs/open_chamber/2compartment_duplicates_4x4_refactored_inserts_v10_1000um/"
device_name="2_compartment_4x4_1000um_v10"
design = "open"
wells_pos=3
well_rad=2
rows=1
...
def make_well_insert_all(degrees_in,degrees_out,height_in,height_out):
    ...
    open_duplicates_4x4_empty_top, _, _  = make_well_insert(make_chamber_insert_holes,degrees_in,height_in,False,
                                                            taper_len_extra=taper_len_in_extra,well_rad=pin_dims)
