...
base_path="./designs/open_chamber/2compartment_duplicates_4x4_v2_refactored_inserts/"
design = "open"
wells_pos=3
well_rad=2
rows=1
...
#make pillar from holes
chamber_insert_holes_extrude = solid.linear_extrude(height=insert_height+wells_3d_height*.76)(chamber_insert_holes)
...
taper_len=taper_len*taper_len_factor
...
open_duplicates_4x4_wells=solid.translate([0,0,insert_height])(open_duplicates_4x4_wells)
