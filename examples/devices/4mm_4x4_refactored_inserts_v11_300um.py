...
version="v11"
base_path="./designs/open_chamber/2compartment_duplicates_4x4_refactored_inserts_"+version+"_300um/"
device_name="2_compartment_4x4_300um_"+version
design = "open"
wells_pos=3
well_rad=2
rows=1
...
degrees_in=20
insert_height=4
taper_len_out_extra=0.15
taper_len_in_extra=0.7
pin_height=0.120
pin_inner_height=2
taper_height=0.5
degrees_taper=45
...
r.render(wafer_walls,outfile=osp.join(base_path,"wall_"+device_name+".stl"))
...
def make_well_insert_all(degrees_in,degrees_out,height_in,height_out,inner_well_rad,add_chambers=False):
    ...
    #open_duplicates_4x4_empty_top, _, _  = make_well_insert(make_chamber_insert_holes,degrees_in,height_in,add_chambers,
    #                                                        taper_len_extra=taper_len_in_extra,well_rad=inner_well_rad)
    open_duplicates_4x4_empty_top, _, _  = make_well_insert(make_chambers,degrees_in,height_in,add_chambers,
                                                            taper_len_extra=taper_len_in_extra,well_rad=inner_well_rad)
    ...
    open_duplicates_4x4_empty_top=solid.translate([0,0,-0.0001])(open_duplicates_4x4_empty_top)
...
open_duplicates_4x4_wells = make_well_insert_all(degrees_in, degrees_out,insert_height_in, insert_height,inner_well_rad,add_chambers=True)

#make skirt for inserts
outer_skirt=solid.projection()(open_duplicates_4x4_wells)
inner_skirt=solid.offset(delta=-skirt_thickness)(outer_skirt)
skirt_multi=solid.difference()(outer_skirt,inner_skirt)
#skirt_multi=make_unit_array(skirt,dims,grid_size, dxf=True, alignment = None,units_from_center=units_from_center,alignment_offset=alignment_offset,alignment_mark_size=alignment_mark_size)
...
#open_duplicates_4x4_wells=solid.union()(open_duplicates_4x4_wells,chamber_insert_holes_extrude_multi,chamber_insert_holes_pyramid)
open_duplicates_4x4_wells=solid.union()(open_duplicates_4x4_wells,chamber_insert_holes_extrude_multi,skirt_multi)
save_model(open_duplicates_4x4_wells,base_path,device_name+"_wells_insert",dxf=False)
