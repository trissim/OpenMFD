...
def scad_to_stl(
    ...
    return run_openscad_export(scad_path, stl_path, openscad_config)
...
def render_stl_with_viewscad(
    ...
    try:
        ...
        raise ImportError(
            "viewscad is required for STL rendering. Install with: pip install viewscad"
        )
    ...
    # Create renderer
    renderer = viewscad.Renderer(width=render_config.width, height=render_config.height)
