// Generated by SolidPython 1.1.3 on 2025-09-12 14:58:33
...
union() {
					...
					difference() {
						difference() {
							difference() {
								union() {
									difference() {
										...
										translate(v = [0, 0, 0.7500000000]) {
											cube(center = true, size = [127.5000000000, 85.3500000000, 1.5000000000]);
										}
									}
									intersection() {
										difference() {
											...
											translate(v = [0, 0, 0.7500000000]) {
												cube(center = true, size = [126.3000000000, 84.1500000000, 1.5000000000]);
											}
										}
										union() {
								...
								union() {
									translate(v = [-63.7510000000, 42.6760000000, 3.5000000000]) {
										translate(v = [0, -10.8500000000, 0]) {
											linear_extrude(height = 13.5000000000) {
												polygon(points = [[0, 0], [0, 10.8500000000], [0, 10.8500000000], [0, 10.8500000000], [10.8500000000, 10.8500000000], [10.8500000000, 10.8500000000]]);
											}
										}
									}
									translate(v = [-63.7510000000, -42.6760000000, 3.5000000000]) {
										translate(v = [10.8500000000, 0, 0]) {
											rotate(a = 90) {
												linear_extrude(height = 13.5000000000) {
													polygon(points = [[0, 0], [0, 10.8500000000], [0, 10.8500000000], [0, 10.8500000000], [10.8500000000, 10.8500000000], [10.8500000000, 10.8500000000]]);
												}
						...
						translate(v = [0, 0, 1.8990000000]) {
							difference() {
								cube(center = true, size = [112.2000000000, 76.2000000000, 0.8000000000]);
								cube(center = true, size = [109, 73, 0.8000000000]);
							}
						}
					}
					union() {
	...
	translate(v = [0, 0, 17.0000000000]) {
		linear_extrude(center = true, height = 127.5000000000) {
			rotate(a = [0, 0, 90]) {
				linear_extrude(center = true, height = 85.3500000000) {
					polygon(points = [[0, 0], [2.0000000000000004, 0], [0, 0]]);
				}
			}
		}
	}
