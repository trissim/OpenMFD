// Generated by SolidPython 1.1.3 on 2024-10-29 17:51:07


difference() {
	union() {
		translate(v = [0, 22.3333333333, 0]) {
			translate(v = [0, -33.5000000000, 11.0000000000]) {
				cube(center = true, size = [124.1500000000, 4, 12]);
			}
		}
		translate(v = [0, 44.6666666667, 0]) {
			translate(v = [0, -33.5000000000, 11.0000000000]) {
				cube(center = true, size = [124.1500000000, 4, 12]);
			}
		}
		...
		difference() {
			difference() {
				difference() {
					...
					union() {
						translate(v = [0, -38.25, 0]) {
							translate(v = [0, 0, 11.0000000000]) {
								cube(center = true, size = [99, 3.5000000000, 12]);
							}
						}
						translate(v = [0, 38.25, 0]) {
							translate(v = [0, 0, 11.0000000000]) {
						...
						translate(v = [-57.7875, 0, 0]) {
							translate(v = [0, 0, 11.0000000000]) {
								cube(center = true, size = [4.5750000000, 67, 12]);
							}
						}
						translate(v = [57.7875, 0, 0]) {
							translate(v = [0, 0, 11.0000000000]) {
				...
				union() {
					translate(v = [0, 0, 17.0000000000]) {
						cube(center = true, size = [115.575, 67, 0]);
					}
					translate(v = [0, 0, 17.0000000000]) {
						cube(center = true, size = [99, 76.5, 0]);
					}
				}
			}
			translate(v = [0, 0, 17.0000000000]) {
				union() {
					translate(v = [0, 22.3333333333, 0]) {
						translate(v = [0, -33.5000000000, 0]) {
							translate(v = [0, -11.1666666667, 0]) {
								rotate(a = [0, 90, 0]) {
									cylinder($fn = 64, center = true, h = 124.1500000000, r = 2.5000000000);
								}
							}
						}
					}
					...
					translate(v = [24.7500000000, 0, 0]) {
						translate(v = [-49.5000000000, 0, 0]) {
							translate(v = [-12.3750000000, 0, 0]) {
								rotate(a = [90, 0, 0]) {
									cylinder($fn = 64, center = true, h = 82, r = 2.5000000000);
								}
							}
						}
					}
