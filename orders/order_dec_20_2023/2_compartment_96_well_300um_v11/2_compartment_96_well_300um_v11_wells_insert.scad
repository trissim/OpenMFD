// Generated by SolidPython 1.1.3 on 2023-12-20 14:17:19
									...
									translate(v = [0, 0]) {
										union() {
											translate(v = [9.0000000000, 4.5000000000, 0]) {
												rotate(a = 0) {
													union() {
														translate(v = [3.6911385271, 0]) {
															square(center = true, size = [1.6177229458, 0.4645541085]);
														}
														translate(v = [-3.6911385271, 0]) {
															square(center = true, size = [1.6177229458, 0.4645541085]);
														}
