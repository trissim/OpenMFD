// Generated by SolidPython 1.1.3 on 2022-10-16 23:09:52
...
union() {
	translate(v = [-2.7500000000, -2.7500000000]) {
		translate(v = [35.0000000000, 35.0000000000]) {
			difference() {
				difference() {
					cylinder($fn = 512, h = 0.5000000000, r1 = 65.5000000000, r2 = 65.5000000000);
					rotate(a = 90) {
						difference() {
				...
				rotate(a = 90) {
					translate(v = [-10.0000000000, 47.7585578064, 0]) {
						cube(center = false, size = [20, 5, 0.5000000000]);
					}
				}
			}
		}
