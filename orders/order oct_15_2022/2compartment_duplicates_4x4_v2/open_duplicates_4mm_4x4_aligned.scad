// Generated by SolidPython 1.1.3 on 2022-10-16 23:09:41
			...
			translate(v = [-2.7500000000, -2.7500000000]) {
				translate(v = [35.0000000000, 35.0000000000]) {
					projection() {
						rotate(a = 90) {
							difference() {
								cylinder($fn = 512, h = 1, r1 = 51.5000000000, r2 = 51.5000000000);
								translate(v = [-16.2500000000, 48.8690853199, 0]) {
									cube(center = false, size = [32.5000000000, 2.6309146801, 1]);
								}
							}
						}
					}
