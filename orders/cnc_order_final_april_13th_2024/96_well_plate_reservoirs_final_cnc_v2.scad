// Generated by SolidPython 1.1.3 on 2024-04-27 09:36:38
...
difference() {
	difference() {
		...
		union() {
			translate(v = [0, -38.3375, 0]) {
				translate(v = [0, 0, 11.0000000000]) {
					cube(center = true, size = [99, 3.6750000000, 12]);
				}
			}
			translate(v = [0, 38.3375, 0]) {
				translate(v = [0, 0, 11.0000000000]) {
			...
			translate(v = [-57.875, 0, 0]) {
				translate(v = [0, 0, 11.0000000000]) {
					cube(center = true, size = [4.7500000000, 67, 12]);
				}
			}
			translate(v = [57.875, 0, 0]) {
				translate(v = [0, 0, 11.0000000000]) {
	...
	union() {
		translate(v = [0, 0, 15.5000000000]) {
			cube(center = true, size = [115.75, 67, 3]);
		}
		translate(v = [0, 0, 15.5000000000]) {
			cube(center = true, size = [99, 76.675, 3]);
		}
	}
}
/***********************************************
...
base_path="./orders/cnc_order_final_april_13th/"
