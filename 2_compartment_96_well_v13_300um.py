...
import numpy as np
base_path="./designs/open_chamber/2_compartment_96_well_300um_v13/"
device_name="2_compartment_96_well_300um_v13"
design = "open"
wells_pos=4.5
well_rad=5/2.0
...
open_duplicates_4x4_wells = make_well_insert_all(degrees_in, degrees_out,insert_height_in, insert_height,3,add_chambers=True)
